...
A recent [New York Times article](https://www.nytimes.com/2022/05/15/sports/baseball/oakland-athletics-attendance.html) detailed why the Oakland Athletic's are America's "loneliest baseball team". 
...
* `NOTE` for simplicity's sake, we still only highlight the SF Giants and the Oakland A's. 
